...
class HandleCollisionsAction(Action):
    ...
    def _handle_collision(self, cast):
        ...
        for block in blocks:
            ...
            if ((block_y_adjusted_for_south_collision - player_y >= 0) and (block_y_adjusted_for_south_collision - player_y <= MAX_SPEED_SOUTH))    and    ((player_x <= block_x + (8 + CELL_SIZE / 2)) and (player_x >= block_x - (8 + CELL_SIZE / 2))):
            ...
            if ((player_y - block_y_adjusted_for_north_collision >= 0) and (player_y - block_y_adjusted_for_north_collision <= MAX_SPEED_NORTH))    and    ((player_x <= block_x + (8 + CELL_SIZE / 2)) and (player_x >= block_x - (8 + CELL_SIZE / 2))):
            ...
            if ((player_x - block_x_adjusted_for_west_collision >= 0) and (player_x - block_x_adjusted_for_west_collision <= MAX_SPEED_WEST))    and    ((player_y <= block_y + (8 + CELL_SIZE / 2)) and (player_y >= block_y - (8 + CELL_SIZE / 2))):
            ...
            if ((block_x_adjusted_for_east_collision - player_x >= 0) and (block_x_adjusted_for_east_collision - player_x <= MAX_SPEED_EAST))    and    ((player_y <= block_y + (8 + CELL_SIZE / 2)) and (player_y >= block_y - (8 + CELL_SIZE / 2))):
